...
//            Log.e("anan", "scanBluetooth: 开始扫描...");
            mListDevices.clear();
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {

//                Log.e("anan", "scanBluetooth: 高功耗扫描模式");
...
//                            log(device.toString());
//                            Log.e("anan", "ble run: " + device.getName());
...
//                                Log.e("anan", "onScanResult: gbk" + moduleName);
                            }
                        }
...
//                Log.e("anan", "onScanResult: " + moduleName);
